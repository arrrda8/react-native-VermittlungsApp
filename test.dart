...
class _ServiceProviderProfilePageState extends State<ServiceProviderProfilePage> {
  ...
  Future<void> fetchServices() async {
    try {
      ...
      print('Gefundene Dienstleistungen: ${servicesList.length}');
                                                      ...
                                                      ExpansionTile(
                                                        ...
                                                        children: services.map<Widget>((s) {
                                                          return ListTile(
                                                            ...
                                                            trailing: Text('${s['price'] ?? "auf Anfrage"} €', style: TextStyle(color: textColor)),
                                                          );
                                                        }).toList(),
                                                      ),
                                                    ],
                                          ...
                                          if (pickedFile != null) {
                                            ...
                                            if (cropped != null) {
                                              ...
                                              await FirebaseFirestore.instance.collection('users')
                                                  ...
                                                  .add({
                                                'imageUrl': imageUrl,
                                                'timestamp': FieldValue.serverTimestamp() // Zeitstempel hinzufügen
                                              });
                                            }
                                          }
                                        },
